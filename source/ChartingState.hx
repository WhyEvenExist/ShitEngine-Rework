...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		leftIcon.setGraphicSize(Std.int(leftIcon.width * 0.5));
		rightIcon.setGraphicSize(Std.int(leftIcon.width * 0.5));

		leftIcon.setPosition((gridBG.width / 4) - (leftIcon.width / 2), -100);
		rightIcon.setPosition((gridBG.width / 4) * 3 - (rightIcon.width / 2), -100);
	...
	function addSongUI():Void
	{
		...
		{
			case 0:
				diffDrop.selectedLabel = "Easy";
				diffDropFinal = "-easy";
			case 1:
				diffDrop.selectedLabel = "Normal";
				diffDropFinal = "";
			case 2:
				diffDrop.selectedLabel = "Hard";
				diffDropFinal = "-hard";
		}
