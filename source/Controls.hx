...
typedef GameKey = OneOfTwo<FlxKey, FlxGamepad>;
...
class Controls extends FlxActionSet
{
	...
	static function loadControls()
	{
		...
		var controlsStrings = CoolUtil.coolTextFile('assets/data/controls.txt'); // im lazy rn
	...
	public static function saveControls()
	{
		...
		sys.io.File.saveContent('assets/data/controls.txt', name4);
	}
